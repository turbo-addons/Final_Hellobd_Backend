...
class GeneralWebsiteSettingsController extends Controller
{
    ...
    public function update(Request $request, GeneralSetting $generalSetting)
    {
        ...
        if ($request->hasFile('site_logo')) {
            ...
            if ($generalSetting->site_logo && file_exists(public_path('storage/logos/' . $generalSetting->site_logo))) {
                unlink(public_path('storage/logos/' . $generalSetting->site_logo));
            }
        ...
        if ($request->hasFile('fav_icon')) {
            // Delete old file if exists
            if ($generalSetting->fav_icon && file_exists(public_path('storage/icons/' . $generalSetting->fav_icon))) {
                unlink(public_path('storage/icons/' . $generalSetting->fav_icon));
            }
