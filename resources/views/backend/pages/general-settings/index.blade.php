                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    @if($settings->site_logo)
                                        <img src="{{ asset('storage/logos/' . $settings->site_logo) }}" alt="Site Logo" class="w-16 h-16" >
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    @if($settings->fav_icon)
                                        <img src="{{ asset('storage/icons/' . $settings->fav_icon) }}" alt="Fav icon" class="w-16 h-16" >
                                    @endif
                                </div>
                            </div>
